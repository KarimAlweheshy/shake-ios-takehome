...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    lazy var imagesRepository: ImagesRepositoryProtocol = ImagesRepository()
    lazy var watchedStoriesRepository: WatchedStoriesRepositoryProtocol = WatchedStoriesRepository()
    lazy var homeFactory: HomeFactory = HomeFactory(
        userService: userService,
        imagesRepository: imagesRepository,
        watchedStoriesRepository: watchedStoriesRepository,
        storiesPlayerFactory: storiesPlayerFactory
    )
    lazy var storiesPlayerFactory = StoriesPlayerFactory(imageRepository: imagesRepository)
